...
- Consistent with your `.Rd` documentation
- Suitable for **CRAN-style package repositories**
- Clear to reviewers and users

If you want, I can also:
- auto-generate this from `README.Rmd`,
- shorten it for CRAN checks,
- or align it with a **journal simulation section**.
```
